   ...
   .la{
    ...
    <script>
      ...
      var selectmarker=[];
        ...
        function nearby(center) {
            ...
            service.nearbySearch(
            {
                ...
                (results, status, pagination) => {
                    if (status !== "OK") return;
                    createMarkers(results, type, map);
        ...
        function createMarkers(places, type, map) {
            $('#info_close').click();
            console.log(places)
            for (let i = 0, place; (place = places[i]); i++) {
                const image = {
                    url: '/planner/resources/ij_resources/'+type+'.png',
    ...
    <div align="center" >
        <ul id="hj_menu">
            ...
            <li class=hj_m2>&nbsp;&nbsp;&nbsp;&nbsp;${my_name}&nbsp;&nbsp;&nbsp;&nbsp;</li>
            <li class=hj_m2>&nbsp;&nbsp;&nbsp;&nbsp;${my_start}&nbsp;&nbsp;&nbsp;&nbsp;</li>
            <li class=hj_m2>&nbsp;&nbsp;&nbsp;&nbsp;${my_city}&nbsp;&nbsp;&nbsp;&nbsp;</li>
            <div id=log-out>
    		...
    		<div id="profile">
          	...
          	<div id="save_div">
                <li class=hj_m2><button id="save">완료</button></li>
            </div>
        </ul>
    </div>   
    <br><br><br>
    ...
    <div id="right-panel">
        ...
        <input type="hidden" id="center" lat='${my_lat}' lng='${my_lng}'>
    ...
    <table id="main_table" >
        <tr>
            <td id="days_td">
                ...
                <input type="hidden" id="plans_name" value="${my_name}" name="my_name">
                <input type="hidden" id="plans_start" value="${my_start}" name="my_start">
                <input type="hidden" id="plans_object" value="" name="my_place">
                <input type="hidden" id="plans_city" value="${my_city}" name="my_city">
                <table id="days_table" >
                    <tr>
                        <td >
                            <div id="days_div">
                            <table id="days_board" >
                                <tr class="days" id="1"><td colspan="2"><div>DAY1</div></td></tr>
                                <tr><td><button id="day_plus">DAY+</button></td></tr>
                            </table>
                            </div>
                        </td>
                        <td>
...
<script>
	function save_plan() {
	    $.ajax({
	            ...
	            url:'ij_save_my_plan',
	            datatype:'text',
	            data:{t_id:$('#planner_name').val(), my_name:$('#plans_name').val(), my_start:$('#plans_start').val(), my_place:$('#plans_object').val(), my_city:$('#plans_city').val()}
	    }).done(function() {
	       location.href="ij_my_plan_page";   
	    })
	}
    $(document).ready(function () {
    console.log('type'+$('#locate_type').val())
    $('#type_check td:eq(0)').click();
    setTimeout(function(){$('.days[id="1"]').click()},200);
    })
    .on('click', '#save', function () {
        ...
        setTimeout(function(){save_plan()},300);
    })
